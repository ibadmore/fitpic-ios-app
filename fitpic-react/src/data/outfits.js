...
const OUTFIT_DATA = [
    {
        ...
        // New filter attributes for modal filtering
    ...
    },
    {
        ...
        // New filter attributes for modal filtering
        filterLocation: ['london', 'new-york', 'tokyo'],
        filterStyle: ['casual', 'minimalist'],
        filterEvent: ['casual', 'work'],
        filterSeason: ['fall', 'spring'],
        title: 'Casual Cool',
    ...
    },
    {
        ...
        // New filter attributes for modal filtering
        filterLocation: ['milan', 'paris', 'london'],
        filterStyle: ['elegant', 'classic'],
        filterEvent: ['wedding', 'work'],
        filterSeason: ['spring', 'fall'],
    ...
    },
    {
        ...
        filterCategories: ['cold-days'],
        // New filter attributes for modal filtering
        filterLocation: ['new-york', 'tokyo', 'london'],
        filterStyle: ['streetwear', 'casual'],
        filterEvent: ['casual', 'travel'],
        filterSeason: ['winter', 'fall'],
        title: 'Urban Edge',
    ...
    },
    {
        ...
        filterCategories: ['date-night'],
        // New filter attributes for modal filtering
        filterLocation: ['los-angeles', 'miami', 'paris'],
        filterStyle: ['casual', 'minimalist'],
        filterEvent: ['casual', 'travel'],
        filterSeason: ['summer', 'spring'],
        title: 'Summer Vibes',
